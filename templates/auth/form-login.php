...
<p>
	...
	echo wp_kses_post( sprintf( __( 'To connect to %1$s you need to be logged in. Log in to your store below, or <a href="%2$s">cancel and return to %1$s</a>', 'classic-store'), esc_html( wc_clean( $app_name ) ), esc_url( $return_url ) ) );
	?>
</p>
...
<form method="post" class="wc-auth-login">
	...
	<p class="wc-auth-actions">
		...
		<button type="submit" class="button button-large button-primary wc-auth-login-button" name="login" value="<?php esc_attr_e( 'Login', 'classic-store'); ?>"><?php esc_html_e( 'Login', 'classic-store'); ?></button>
