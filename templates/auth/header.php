...
<head>
	...
	<title><?php esc_html_e( 'Application authentication request', 'classic-store'); ?></title>
...
<body class="wc-auth wp-core-ui">
	<h1 id="wc-logo"><img src="<?php echo esc_url( WC()->plugin_url() ); ?>/assets/images/classic-commerce-logo.png" alt="<?php esc_attr_e( 'Classic Commerce', 'classic-store'); ?>" /></h1>
