...
<form method="get" action="<?php echo esc_url( $form_action ); ?>">
	<div class="price_slider_wrapper">
		...
		<div class="price_slider_amount" data-step="<?php echo esc_attr( $step ); ?>">
            <label class="screen-reader-text" for="min_price"><?php esc_html_e( 'Min price', 'classic-commerce' ); ?></label>
            ...
            <label class="screen-reader-text" for="max_price"><?php esc_html_e( 'Max price', 'classic-commerce' ); ?></label>
			...
			<button type="submit" class="button"><?php echo esc_html__( 'Filter', 'classic-commerce' ); ?></button>
			<div class="price_label" style="display:none;">
				<?php echo esc_html__( 'Price:', 'classic-commerce' ); ?> <span class="from"></span> &mdash; <span class="to"></span>
			</div>
