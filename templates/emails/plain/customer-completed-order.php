...
echo sprintf( esc_html__( 'Your %s order has been marked complete on our side.', 'classic-store'), esc_html( wp_specialchars_decode( get_option( 'blogname' ), ENT_QUOTES ) ) ) . "\n\n";
