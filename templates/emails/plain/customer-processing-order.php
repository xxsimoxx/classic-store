...
echo sprintf( esc_html__( 'Just to let you know &mdash; we\'ve received your order #%s, and it is now being processed:', 'classic-store'), esc_html( $order->get_order_number() ) ) . "\n\n";
