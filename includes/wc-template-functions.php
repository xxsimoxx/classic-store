...
function wc_generator_tag( $gen, $type ) {
	...
	switch ( $type ) {
		case 'html':
			$gen .= "\n" . '<meta name="generator" content="Classic Commerce ' . esc_attr( $cc_version ) . '">';
			break;
		case 'xhtml':
			$gen .= "\n" . '<meta name="generator" content="Classic Commerce ' . esc_attr( $cc_version ) . '" />';
			break;
...
if ( ! function_exists( 'woocommerce_template_loop_product_title' ) ) {
	...
	function woocommerce_template_loop_product_title() {
		echo '<h2>' . get_the_title() . '</h2>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
	}
}
	...
	function woocommerce_breadcrumb( $args = array() ) {
		$args = wp_parse_args(
			...
			apply_filters(
				...
				array(
					'delimiter'   => '&nbsp;&#47;&nbsp;',
					'wrap_before' => '<div class="woocommerce-breadcrumb" aria-label="Breadcrumb">',
					'wrap_after'  => '</div>',
					'before'      => '',
					'after'       => '',
