...
class WC_Order_Refund_Data_Store_CPT extends Abstract_WC_Order_Data_Store_CPT implements WC_Object_Data_Store_Interface, WC_Order_Refund_Data_Store_Interface {
	...
	protected function get_post_title() {
		return sprintf(
			...
			__( 'Refund &ndash; %s', 'classic-store'),
			strftime( _x( '%b %d, %Y @ %I:%M %p', 'Order date parsed by strftime', 'classic-store') ) // phpcs:ignore WordPress.WP.I18n.MissingTranslatorsComment, WordPress.WP.I18n.UnorderedPlaceholdersText
		);
	}
}
