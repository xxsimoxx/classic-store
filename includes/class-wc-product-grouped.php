...
class WC_Product_Grouped extends WC_Product {
	...
	public function add_to_cart_text() {
		return apply_filters( 'woocommerce_product_add_to_cart_text', __( 'View products', 'classic-store'), $this );
	}
	...
	public function add_to_cart_description() {
		...
		return apply_filters( 'woocommerce_product_add_to_cart_description', sprintf( __( 'View products in the &ldquo;%s&rdquo; group', 'classic-store'), $this->get_name() ), $this );
	}
	...
	public function get_price_html( $price = '' ) {
		...
		if ( '' !== $min_price ) {
			...
			if ( $is_free ) {
				$price = apply_filters( 'woocommerce_grouped_free_price_html', __( 'Free!', 'classic-store'), $this );
			} else {
