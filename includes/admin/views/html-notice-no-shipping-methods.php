...
<div id="message" class="updated woocommerce-message">
	...
	<p class="main">
		<strong>
			<?php esc_html_e( 'Add shipping methods &amp; zones', 'classic-commerce' ); ?>
		</strong>
	</p>
	<p>
		<?php esc_html_e( 'Shipping is currently enabled, but you have not added any shipping methods to your shipping zones.', 'classic-commerce' ); ?>
	</p>
	<p>
		<?php esc_html_e( 'Customers will not be able to purchase physical goods from your store until a shipping method is available.', 'classic-commerce' ); ?>
	</p>
		...
		<a class="button-secondary" href="https://classiccommerce.cc/docs/installation-and-setup/shipping/">
			<?php esc_html_e( 'Learn more about shipping zones', 'classic-commerce' ); ?>
		</a>
	</p>
</div>
