...
<div id="message" class="updated wc-connect">
	...
	<p>
		...
		echo sprintf( wp_kses( __( 'Are you using WooCommerce-specific extensions? They might require the <a href="%s">compatibility plugin</a> in order to work correctly.', 'classic-store'), array( 'a' => array( 'href' => array() ) ) ), esc_url( admin_url( 'admin.php?page=wc-addons#cc-compat' ) ) );
		?>
	</p>
