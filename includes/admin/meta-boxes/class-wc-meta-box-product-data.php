...
class WC_Meta_Box_Product_Data {
	...
	private static function get_product_type_options() {
		/* phpcs:disable ClassicCommerce.Commenting.CommentHooks.MissingHookComment */
	...
	public static function save( $post_id, $post ) {
		...
		$errors = $product->set_props(
			array(
				...
				'low_stock_amount'   => isset( $_POST['_low_stock_amount'] ) && '' !== $_POST['_low_stock_amount'] ? wc_stock_amount( wp_unslash( $_POST['_low_stock_amount'] ) ) : null,
		...
		/* phpcs:enable WordPress.Security.NonceVerification.Missing and ClassicCommerce.Commenting.CommentHooks.MissingHookComment */
	}
