...
class WC_Report_Taxes_By_Date extends WC_Admin_Report {
	...
	public function get_export_button() {
		...
		<a
			...
			data-export="table"
		>
			<?php _e( 'Export CSV', 'classic-store'); ?>
		</a>
		<?php
	}
	...
	public function get_main_chart() {
		...
		<table class="widefat">
			<thead>
				<tr>
					<th><?php _e( 'Period', 'classic-store'); ?></th>
					<th class="total_row"><?php _e( 'Number of orders', 'classic-store'); ?></th>
					<th class="total_row"><?php _e( 'Total sales', 'classic-store'); ?> <?php echo wc_help_tip( __( "This is the sum of the 'Order total' field within your orders.", 'classic-store') ); ?></th>
					<th class="total_row"><?php _e( 'Total shipping', 'classic-store'); ?> <?php echo wc_help_tip( __( "This is the sum of the 'Shipping total' field within your orders.", 'classic-store') ); ?></th>
					<th class="total_row"><?php _e( 'Total tax', 'classic-store'); ?> <?php echo wc_help_tip( __( 'This is the total tax for the rate (shipping tax + product tax).', 'classic-store' ) ); ?></th>
					<th class="total_row"><?php _e( 'Net profit', 'classic-store'); ?> <?php echo wc_help_tip( __( 'Total sales minus shipping and tax.', 'classic-store') ); ?></th>
				</tr>
			</thead>
			<?php if ( ! empty( $tax_rows ) ) : ?>
				...
				<tfoot>
					...
					?>
					<tr>
						<th scope="row"><?php _e( 'Totals', 'classic-store'); ?></th>
			...
			<?php else : ?>
				<tbody>
					<tr>
						<td><?php _e( 'No taxes found in this period', 'classic-store'); ?></td>
					</tr>
				</tbody>
			<?php endif; ?>
		</table>
