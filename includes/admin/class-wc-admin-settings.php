...
if ( ! class_exists( 'WC_Admin_Settings', false ) ) :
	...
	class WC_Admin_Settings {
		 ...
		 * Settings page.
		 *
		 * Handles the display of the main Classic Commerce settings page in admin.
		 */
		 ...
		 * Output admin fields.
		 *
		 * Loops through the Classic Commerce options array and outputs each field.
		 *
		...
		public static function output_fields( $options ) {
			foreach ( $options as $value ) {
				...
				switch ( $value['type'] ) {
					...
					// Image width settings. @todo deprecate and remove in WC-4.0. No longer needed by core.
					case 'image_width':
