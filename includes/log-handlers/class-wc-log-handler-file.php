...
class WC_Log_Handler_File extends WC_Log_Handler {
	...
	public static function get_log_file_path( $handle ) {
		if ( function_exists( 'wp_hash' ) ) {
			...
			wc_doing_it_wrong( __METHOD__, __( 'This method should not be called before plugins_loaded.', 'classic-store'), '3.0' );
			return false;
		}
	}
	...
	public static function get_log_file_name( $handle ) {
		if ( function_exists( 'wp_hash' ) ) {
			...
			wc_doing_it_wrong( __METHOD__, __( 'This method should not be called before plugins_loaded.', 'classic-store'), '3.3' );
			return false;
		}
	}
