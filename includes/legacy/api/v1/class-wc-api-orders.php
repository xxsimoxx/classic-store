...
class WC_API_Orders extends WC_API_Resource {
	...
	public function get_orders_count( $status = null, $filter = array() ) {
		...
		if ( ! current_user_can( 'read_private_shop_orders' ) ) {
			return new WP_Error( 'woocommerce_api_user_cannot_read_orders_count', __( 'You do not have permission to read the orders count', 'classic-store'), array( 'status' => 401 ) );
		}
