			...
			<td class="forminp">
				<fieldset>
					...
					<?php if ( $data['select_buttons'] ) : ?>
						<br/><a class="select_all button" href="#"><?php esc_html_e( 'Select all', 'classic-store'); ?></a> <a class="select_none button" href="#"><?php esc_html_e( 'Select none', 'classic-store'); ?></a>
					<?php endif; ?>
				</fieldset>
			</td>
		</tr>
