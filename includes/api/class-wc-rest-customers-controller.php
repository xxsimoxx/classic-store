	...
	public function get_item_schema() {
		$schema = array(
			...
			'properties' => array(
				...
				'date_created'       => array(
					'description' => __( "The date the customer was created, in the site's timezone.", 'classic-store'),
					'type'        => 'date-time',
					'context'     => array( 'view', 'edit' ),
					'readonly'    => true,
				),
				...
				'date_modified'      => array(
					'description' => __( "The date the customer was last modified, in the site's timezone.", 'classic-store'),
					'type'        => 'date-time',
					'context'     => array( 'view', 'edit' ),
					'readonly'    => true,
				),
				...
				'role'               => array(
					'description' => __( 'Customer role.', 'classic-store'),
					'type'        => 'string',
					'context'     => array( 'view', 'edit' ),
					'readonly'    => true,
				),
				...
				'is_paying_customer' => array(
					'description' => __( 'Is the customer a paying customer?', 'classic-store'),
					'type'        => 'bool',
					'context'     => array( 'view', 'edit' ),
					'readonly'    => true,
				),
