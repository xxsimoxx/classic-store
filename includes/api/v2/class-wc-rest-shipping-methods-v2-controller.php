...
class WC_REST_Shipping_Methods_V2_Controller extends WC_REST_Controller {
	...
	public function get_item( $request ) {
		...
		if ( empty( $methods[ $request['id'] ] ) ) {
			return new WP_Error( 'woocommerce_rest_shipping_method_invalid', __( 'Resource does not exist.', 'classic-store'), array( 'status' => 404 ) );
		}
	...
	public function get_item_schema() {
		$schema = array(
			...
			'properties' => array(
				'id'          => array(
					'description' => __( 'Method ID.', 'classic-store'),
					'type'        => 'string',
					'context'     => array( 'view' ),
					'readonly'    => true,
				),
