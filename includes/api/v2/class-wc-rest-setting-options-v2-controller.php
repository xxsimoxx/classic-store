...
class WC_REST_Setting_Options_V2_Controller extends WC_REST_Controller {
	...
	public function register_routes() {
		register_rest_route(
			$this->namespace, '/' . $this->rest_base, array(
				'args'   => array(
					'group' => array(
						'description' => __( 'Settings group ID.', 'classic-store'),
						'type'        => 'string',
					),
				),
				array(
	...
	public function get_group_settings( $group_id ) {
		if ( empty( $group_id ) ) {
			return new WP_Error( 'rest_setting_setting_group_invalid', __( 'Invalid setting group.', 'classic-store'), array( 'status' => 404 ) );
		}
	...
	public function get_setting( $group_id, $setting_id ) {
		if ( empty( $setting_id ) ) {
			return new WP_Error( 'rest_setting_setting_invalid', __( 'Invalid setting.', 'classic-store'), array( 'status' => 404 ) );
		}
	...
	public function get_item_schema() {
		$schema = array(
			...
			'properties' => array(
				...
				'options'     => array(
					'description' => __( 'Array of options (key value pairs) for inputs such as select, multiselect, and radio buttons.', 'classic-store' ),
					'type'        => 'object',
					'context'     => array( 'view', 'edit' ),
					'readonly'    => true,
				),
