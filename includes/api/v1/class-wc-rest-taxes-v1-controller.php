...
class WC_REST_Taxes_V1_Controller extends WC_REST_Controller {
	...
	public function create_item( $request ) {
		if ( ! empty( $request['id'] ) ) {
			return new WP_Error( 'woocommerce_rest_tax_exists', __( 'Cannot create existing resource.', 'classic-store'), array( 'status' => 400 ) );
		}
	...
	public function get_item_schema() {
		$schema = array(
			...
			'properties' => array(
				...
				'country'  => array(
					'description' => __( 'Country ISO 3166 code.', 'classic-store'),
					'type'        => 'string',
					'context'     => array( 'view', 'edit' ),
				),
				'state'    => array(
				...
				'postcode' => array(
					'description' => __( 'Postcode / ZIP.', 'classic-store'),
					'type'        => 'string',
					'context'     => array( 'view', 'edit' ),
				),
				'city'     => array(
				...
				'rate'     => array(
					'description' => __( 'Tax rate.', 'classic-store'),
					'type'        => 'string',
					'context'     => array( 'view', 'edit' ),
				),
				'name'     => array(
					'description' => __( 'Tax rate name.', 'classic-store'),
					'type'        => 'string',
					'context'     => array( 'view', 'edit' ),
				),
				'priority' => array(
					'description' => __( 'Tax priority.', 'classic-store'),
					'type'        => 'integer',
					'default'     => 1,
					'context'     => array( 'view', 'edit' ),
				),
				'compound' => array(
					'description' => __( 'Whether or not this is a compound rate.', 'classic-store'),
					'type'        => 'boolean',
					'default'     => false,
					'context'     => array( 'view', 'edit' ),
				),
				'shipping' => array(
					'description' => __( 'Whether or not this tax rate also gets applied to shipping.', 'classic-store'),
					'type'        => 'boolean',
					'default'     => true,
					'context'     => array( 'view', 'edit' ),
				),
				'order'    => array(
					'description' => __( 'Indicates the order that will appear in queries.', 'classic-store'),
					'type'        => 'integer',
					'context'     => array( 'view', 'edit' ),
				),
				'class'    => array(
	...
	public function get_collection_params() {
		...
		$params['class']    = array(
			'description'       => __( 'Sort by tax class.', 'classic-store'),
			'enum'              => array_merge( array( 'standard' ), WC_Tax::get_tax_class_slugs() ),
