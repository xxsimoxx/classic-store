...
class WC_Widget_Recent_Reviews extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_description = __( 'Display a list of recent reviews from your store.', 'classic-store');
		$this->widget_id          = 'woocommerce_recent_reviews';
		$this->widget_name        = __( 'Recent Product Reviews', 'classic-store');
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
				'std'   => __( 'Recent reviews', 'classic-store'),
			...
			'number' => array(
				...
				'max'   => '',
				'std'   => 10,
				'label' => __( 'Number of reviews to show', 'classic-store'),
			),
		);
