...
class WC_Product_External extends WC_Product {
	...
	*/
	...
	public function set_manage_stock( $manage_stock ) {
		...
		if ( true === $manage_stock ) {
			$this->error( 'product_external_invalid_manage_stock', __( 'External products cannot be stock managed.', 'classic-store') );
		}
	}
	...
	public function set_stock_status( $stock_status = '' ) {
		...
		if ( 'instock' !== $stock_status ) {
			$this->error( 'product_external_invalid_stock_status', __( 'External products cannot be stock managed.', 'classic-store') );
		}
	}
	...
	public function set_backorders( $backorders ) {
		...
		if ( 'no' !== $backorders ) {
			$this->error( 'product_external_invalid_backorders', __( 'External products cannot be backordered.', 'classic-store') );
		}
	}
	...
	*/
	...
	public function single_add_to_cart_text() {
		return apply_filters( 'woocommerce_product_single_add_to_cart_text', $this->get_button_text() ? $this->get_button_text() : _x( 'Buy product', 'placeholder', 'classic-store'), $this );
	}
	...
	public function add_to_cart_text() {
		return apply_filters( 'woocommerce_product_add_to_cart_text', $this->get_button_text() ? $this->get_button_text() : _x( 'Buy product', 'placeholder', 'classic-store'), $this );
	}
	...
	public function add_to_cart_description() {
		...
		return apply_filters( 'woocommerce_product_add_to_cart_description', $this->get_button_text() ? $this->get_button_text() : sprintf( __( 'Buy &ldquo;%s&rdquo;', 'classic-store'), $this->get_name() ), $this );
	}
}
